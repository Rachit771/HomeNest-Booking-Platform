...
const {confirmBookingController,cancelBookingController,createBookingController,getBookingPage,getUserBookings,getPaymentPage}=require('../controllers/bookController')
...
bookingRoute.get("/payment/:id", getPaymentPage);
